...
import com.aristavpn.app.databinding.ActivityLogcatBinding
...
import com.aristavpn.app.viewmodel.LogcatViewModel
    ...
    private fun shareLogcat() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val result = try {
                ...
                val logFile = File(shareDir, "AristaVpN_logcat_$timestamp.txt")
