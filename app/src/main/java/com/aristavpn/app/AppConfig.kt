...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/2dust/AristaVpN"
    const val APP_API_URL = "https://api.github.com/repos/2dust/AristaVpN/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/AristaVpN/master/CR.md"
    ...
    const val RAY_NG_CHANNEL_NAME = "AristaVpN Background Service"
