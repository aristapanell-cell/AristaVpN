package com.aristavpn.app.handler
...
import com.aristavpn.app.AppConfig
import com.aristavpn.app.AppConfig.ANG_PACKAGE
import com.aristavpn.app.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.aristavpn.app.AppConfig.GEOIP_PRIVATE
import com.aristavpn.app.AppConfig.GEOSITE_PRIVATE
import com.aristavpn.app.AppConfig.TAG_DIRECT
import com.aristavpn.app.AppConfig.VPN
import com.aristavpn.app.dto.V2rayConfig
import com.aristavpn.app.dto.entities.ProfileItem
import com.aristavpn.app.dto.entities.RulesetItem
import com.aristavpn.app.dto.entities.SubscriptionItem
import com.aristavpn.app.enums.EConfigType
import com.aristavpn.app.enums.Language
import com.aristavpn.app.enums.RoutingType
import com.aristavpn.app.enums.VpnInterfaceAddressConfig
import com.aristavpn.app.handler.MmkvManager.decodeAllServerList
import com.aristavpn.app.handler.MmkvManager.decodeServerConfig
import com.aristavpn.app.handler.MmkvManager.decodeSubsList
import com.aristavpn.app.handler.MmkvManager.decodeSubscription
import com.aristavpn.app.handler.MmkvManager.encodeSubscription
import com.aristavpn.app.handler.MmkvManager.removeSubscription
import com.aristavpn.app.util.JsonUtil
import com.aristavpn.app.util.LogUtil
import com.aristavpn.app.util.Utils
import java.io.File
